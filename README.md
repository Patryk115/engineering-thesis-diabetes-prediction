...
B.Eng. Engineering Thesis Project > An end-to-end Machine Learning pipeline and interactive web application for early assessment of Type 2 Diabetes risk based on demographic and behavioral data.
...
📸 Application Preview
(Upload a screenshot of your app to this repository, name it app_preview.png, and remove the `` tags below to display it)
...
*.joblib files - Serialized artifacts (Logistic Regression model, scaler, and expected columns) allowing the app to run inference in real-time.

requirements.txt - List of Python dependencies.

👨‍💻 Author
Patryk - Data Engineer / Junior Data Scientist
